...
class UploadFilesToDB:
    ...
    def show_file_search_results_fromdb(self):
        values = cursor.execute('select * from FileSearchResults_table4')
    ...
    def upload_file_results_todb(self,fileName, fileLocation, searchCount):
        query = '''  
                    INSERT INTO FileSearchResults4_table (File_Location, SearchCount, NameOfFile)
                    VALUES
                    ('{0}',{1},'{2}')  '''
    ...
    def search_in_db_for_file(self, fileName):
        # select query
        query = ''' select * from FileSearchResults4_table where NameOfFile = '{0}' '''
    ...
    def update_file_searchcount(self, fileName):
        try:
            ...
            for fileInfo in values:
                ...
                fileinfoQuery = '''
                        Update FileSearchResults4_table SET SearchCount = {0} WHERE NameOfFile = '{1}'
                        '''
